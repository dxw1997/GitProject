...
initial_lr = 0.00003
opt = torch.optim.Adam(model_test.parameters(), lr=initial_lr, weight_decay=1e-6) # try SGD
#opt = optim.SGD(model_test.parameters(), lr = initial_lr, momentum=0.99)
#opt = optim.SGD(model_test.parameters(), lr = initial_lr, momentum=0.90, weight_decay=1e-6)
# SGD optimizer:
